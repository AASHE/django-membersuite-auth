# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-08 03:56
import django
...
if django.get_version() == "1.4.3":
    ...
    class Migration(SchemaMigration):
        ...
        models = {
            ...
            'django_membersuite_auth.membersuiteportaluser': {
                'Meta': {'object_name': 'MemberSuitePortalUser'},
                'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
                'is_member': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
                'membersuite_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
                'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'})
            }
        }

        complete_apps = ['django_membersuite_auth']
else:
